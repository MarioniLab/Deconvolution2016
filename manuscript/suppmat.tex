...
% At higher counts, DESeq and deconvolution approach the same precision, which makes sense as they are computed in a similar manner.
% Library size normalization is most efficient but obviously is only applicable when there is no DE.
