...
% Consider what happens when you repeat this simulation with a constant mean across all genes, and use that mean as the geometric mean in estimateSizeFactorsForMatrix.
...
% Nonetheless, the principle remains.
...
\revised{In practice, $E(\Theta_j)$ and $E(\Theta'_j)$ are unknown so we use $\hat\theta_j$ and $\hat\theta'_j$, respectively, to replace them in the GLM fit.
