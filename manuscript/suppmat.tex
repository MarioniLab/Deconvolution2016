...
\begin{figure}[p]
    \begin{center}
        \begin{minipage}{0.33\textwidth}
            \includegraphics[width=\textwidth,trim=0mm 14mm 2mm 20mm,clip]{results/sizeP_1.pdf}
            \includegraphics[width=\textwidth,trim=0mm 14mm 2mm 20mm,clip]{results/sizeP_4.pdf}
            \subcaption{}\label{subfig:size_prior}
        \end{minipage}
        \begin{minipage}{0.33\textwidth}
            \includegraphics[width=\textwidth,trim=0mm 14mm 2mm 20mm,clip]{results/sizeP2_1.pdf}
            \includegraphics[width=\textwidth,trim=0mm 14mm 2mm 20mm,clip]{results/sizeP2_4.pdf}
...
Specifically, deconvolution is applied separately on each cluster of cells to obtain sets of cell-based size factors.
These values are adjusted via pairwise normalization between clusters to yield the final factor estimates.
...
More details on the construction on the linear system are given in Section~\ref{sec:systemconstruct} below.
...
Some protection is provided by using linear inverse models in the limSolve package (v1.5.5.1, \url{https://cran.r-project.org/web/packages/limSolve/index.html}) to constrain the estimates to non-negative values.
...
Summation of cells with similar library sizes (and by implication, similar expression profiles) reduces the number of DE genes in the cell pool relative to the reference pseudo-cell.
This weakens the assumption of a non-DE majority that is required for deconvolution (see Section~\ref{sec:de_assumption}).
