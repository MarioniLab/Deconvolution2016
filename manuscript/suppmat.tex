...
Indeed, we repeated the no-DE simulation in Figures~\figexist{} and \figdeconv{} and computed the MAD of the log-size factor estimates for each cell across 10 iterations.
