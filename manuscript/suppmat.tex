...
\begin{table}[ptb]
    \caption{
        Proportion of the top set of genes that were shared between deconvolution and each existing normalization method.
...
\begin{table}[ptb]
    \caption{ Proportion of genes identified as highly variable shared between the established normalization methods and deconvolution. The variability
        of gene expression was estimated by computing the distance of the squared CV (coefficient of variation) and a running median, referred to as DM \cite{Kim2015}. Top genes
        were identified as those with the largest DM value. For both datasets, top sets of ranges between 500 and 2000 were compared.
    }
    \begin{center}
        \begin{tabular}{l r r r r}
            \hline
