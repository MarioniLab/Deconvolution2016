...
This ensures that any estimation error is large enough so that changes in precision can be observed.)
...
This is not unreasonable given the simulation results (Figure~\ref{whee}), and can be written as
\[
