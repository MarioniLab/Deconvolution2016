...
\end{bmatrix}
\]
for pool-based size factor estimates $\hat\theta_A$ to $\hat\theta_D$. 
...
The addition of equations relating each \revised{size factor} with its direct estimate $\hat\theta_j$ ensures identifiability, 
