...
Systematic zeroes refer to genes that are constitutively silent in a cell (sub)population, such that the count will be zero for all cells in that population.
