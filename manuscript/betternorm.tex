...
\revised{Let the count of a non-DE gene $i$ in cell $j$ be sampled from some distribution $Y_{ij}$ with mean $\theta_j\lambda_{i0}$, where $\theta_j$ is the cell-specific bias and $\lambda_{i0}$ is the expected transcript count.
