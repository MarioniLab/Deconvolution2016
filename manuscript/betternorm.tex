...
% In less-friendly cases, the smaller pools are necessary to mitigate errors from pooling together cells with very different size factors.
% Conversely, the larger pools are necessary for very low counts where the smaller pools might not be accurate.
