...
Systematic zeroes within a cluster are also removed prior to deconvolution in that cluster.
This refers to genes that only have zero counts across all cells in the cluster.
