...
Similar changes are observed for highly variable genes detected using the distance-to-median approach \cite{kolod2015single}.
Approximately 10 - 30\% and 15 - 50\% of the top-ranked genes change in the brain and inDrop data sets, respectively,
    if deconvolution is used instead of the existing methods (Supplementary Table~\suppHVG{}).
