...
The approximation \revised{in Equation~\ref{eqn:linear_single}} assumes that the \revised{observed $u_{i}$ is close to $E(U_i)$}
...
\revised{$E(R_{ik})$} is estimated by taking a robust average (i.e., the median) of $r_{ik}$ across \revised{all genes}.
