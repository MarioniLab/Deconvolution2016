...
\begin{figure}[btp]
    \begin{tabular}{p{\cellwidth}@{}p{\cellwidth}@{}p{\cellwidth}@{}l}
        ...
        \raisebox{-.5\height}{\includegraphics[width=\cellwidth,trim=0mm 5mm 0mm 15mm,clip]{realdata/Zeisel_LibvDeconv.pdf}} & 
         {\small\rotatebox[origin=c]{270}{\textsf{Brain}}} \\
        ...
        {\small\rotatebox[origin=c]{270}{\textsf{inDrop}}} \\
    \end{tabular}
    \caption{
...
It is publicly available as part of the scran package on GitHub (\url{https://github.com/MarioniLab/scran}).
