...
reaching the smallest libraries at 6 o'clock; and then, continuing to move clockwise through the odd cells with increasing library size (Supplementary Figure~\suppring{}).
...
The DE analysis was performed on each data set using methods in edgeR v3.12.0.
...
This file contains additional details on the theory behind the deconvolution method, as well as some extra real data and simulation results.
