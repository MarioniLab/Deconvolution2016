...
\revised{A description of the time complexity of the deconvolution method is provided in Section~\supptimecomp{} and Supplementary Figure~\supptimings{} of Additional file~1.}
...
This is observed for all groups in all tested data sets (Figure~\suppdeassess{}), consistent with increased accuracy in the simulations.
