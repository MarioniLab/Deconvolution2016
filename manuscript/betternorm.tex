...
Briefly, this includes a description of the use of linear inverse models to protect against negative estimates of $\theta_j$; 
    a justification for the choice of $T_j$ in count adjustment;
    a description of the assumption of a non-DE majority of genes, and the weakening of that assumption with clustering;
    and a description of the strategy used to choose cells in each $\mathcal{S}_{ik}$ for construction of the linear system (see also Supplementary Figure~\suppring{}).
