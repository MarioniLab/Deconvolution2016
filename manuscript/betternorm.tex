...
These were considered to be systematic zeroes (with some non-zero counts due to residual transcription, mapping errors, etc.) and removed prior to further processing.
The set of External RNA Controls Consortium (ERCC) spike-ins in the brain data set were also removed before any normalization was performed.
...
Differences are also present between deconvolution and library size normalization.
This is attributable to the likely presence of DE genes across the data set.
Any moderate-to-strong DE between cells is sufficient to confound library size normalization.
...
%        \includegraphics[width=\textwidth]{
    ...
    \caption{
        ...
        Axes are on a log-scale, and cells are coloured according by their clustering prior to deconvolution.
    }
    \label{fig:real_comp}  
\end{figure}
