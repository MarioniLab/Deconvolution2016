...
\revised{Our simulations compare the performance of the various methods on low-coverage data where zeroes are expected to be prevalent.
To examine performance at higher coverage, we repeated the simulations with different parameters to obtain larger counts (Section~\supphighcov{}, Additional file~1).
