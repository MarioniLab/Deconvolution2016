...
DESeq normalization was originally introduced as part of the DESeq package for differential expression \cite{anders2010differential}.
...
Conversely, a library with zero counts for a majority of genes may have a size factor of zero, which precludes any sensible scaling.
