...
We propose a new method for normalization that where expression values are summed across pools of cells, and the summed values are used for median-based normalization.
...
The deconvolution method overcomes the deficiencies of existing methods for normalization of RNA sequencing data.
