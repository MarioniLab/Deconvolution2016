...
\revised{Each of these three normalization methods was initially developed for analysis of bulk RNA-seq data.
...
Thus, an assessment of the suitability of these methods for single-cell data is not irrelevant.
}
