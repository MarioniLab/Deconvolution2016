...
Similar behaviour is observed in real data, where deconvolution also changes the results of downstream analyses.
...
This work was supported by core funding from Cancer Research UK.
