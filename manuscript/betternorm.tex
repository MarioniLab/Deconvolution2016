...
%
% Of course, the main motivation is to reduce the number of zeros. 
...
% The effective value is probably lower because some zeros are semi-systematic and smaller cells will have more stochastic zeros anyway, but still; pretty good.
