...
\newcommand{\supptimecomp}{4}
\newcommand{\supprealassess}{5}
%\newcommand{\suppspikesec}{3}

\newcommand{\supppseudo}{S1}
\newcommand{\suppring}{S2}
\newcommand{\suppdeassess}{S3}
...
\revised{A simple simulation in Section~\supppoolsim{} of the Supplementary Materials demonstrates that the selection of cell pools through the ring arrangement provides a modest improvement in estimation precision compared to the use of random pools.}
...
\revised{A discussion of the time complexity of the method is also provided in Section~\supptimecomp{} of the Supplementary Materials.}
