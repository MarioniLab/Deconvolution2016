...
% Uee the following: www.stat.cmu.edu/~hseltman/files/ratio.pdf, where E(V/U) ~= E(V)/E(U) - cov(V, U)/E(U)^2 + var(U)E(V)/E(U)^3
% We note that, in this setting, U=(V+X)/N where X is independent of V and represents all the other cells.
