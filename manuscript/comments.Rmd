...
I have tried a number of alternatives to address this problem at the source:
...
# We can fix this by iterating and using the first-round size factors as t_j.
Y <- computeSumFactors(counts, min.mean=0, scaling=X)
makeSFPlot(Y, truth, de.cell,col=rep(c("red", "blue"), c(10, 90)))
```
...
## Why use a library size-sorted ring?
