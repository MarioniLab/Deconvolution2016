...
This is because you are more likely to select genes that are upregulated (truly or stochastically) in cells with small size factors, in order to avoid zeroes.
